var size = 0;
var placement = 'point';
function categories_KETERANGAN_KERUSAKAN_SALURAN_8(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
                switch(valueStr) {case 'Baik':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(66,255,33,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 3.8}),
...
var style_KETERANGAN_KERUSAKAN_SALURAN_8 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_KETERANGAN_KERUSAKAN_SALURAN_8(feature, value, size, resolution, labelText,
